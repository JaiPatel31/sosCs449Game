...
public class gameUI {
    ...
    private void illegalSize(IllegalArgumentException ex){
        gameUtils.startNewGame(5, topMenu.getMode(),rightMenu.getRedType(), leftMenu.getBlueType(), gameBoardUI,false); // Default size 5
    ...
    private void validSize(){
        ...
        gameUtils.startNewGame(size, topMenu.getMode(),rightMenu.getRedType(), leftMenu.getBlueType(), gameBoardUI,false); // Start game
        resetGame(size);
    }
